...
//        int columnSpacing = 10;
        ...
        for (Article article : articles) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/articleCardClient.fxml"));
    ...
    public void loadArticles() throws IOException, SQLException {
        ...
        for (Article article : articles) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/articleCardClient.fxml"));
