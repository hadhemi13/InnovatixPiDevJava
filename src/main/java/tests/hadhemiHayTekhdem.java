...
public class hadhemiHayTekhdem {
    public static void main(String[] args) {
        ...
        String textToConvert = "salut Innovatix je suis text to speech et je travaille très bien et je vais prendre 20"; // Remplacez "Votre texte ici" par le texte que vous souhaitez convertir en discours.
